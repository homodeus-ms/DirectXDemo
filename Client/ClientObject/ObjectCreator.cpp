	...
	: _shader(shader)
{
	// Kachujin 로드
	{
		...
		_kachujin->ReadAnimation(L"Kachujin/Slash");    // Index번호 : Enum값 ANIM_SKILL 단순 공격 
		_kachujin->ReadAnimation(L"Kachujin/Slash");    // Index번호 : Enum값 ANIM_SPECIAL_SKILL 광역 공격
	}
